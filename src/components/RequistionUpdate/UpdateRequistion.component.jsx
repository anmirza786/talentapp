...
import "./UpdateRequistion.styles.css";
...
const UpdateRequistion = ({
  ...
  const [specialityval, setspecialityval] = React.useState(
    props.state.sepcialityid
  );
  const [requistionno, setrequistionno] = React.useState(
    props.state.requisitionno
  );
  const [totalteam, settotalteam] = React.useState(props.state.totalteam);
  const [teamcost, setteamcostno] = React.useState(props.state.teamcost);
  const [noofdays, setnoofdays] = React.useState(props.state.noofdays);
  const [startdate, setstartdate] = React.useState(
    moment(props.state.startdate).utc().format("YYYY-MM-DD")
  );
  const [enddate, setenddate] = React.useState(
    moment(props.state.enddate).utc().format("YYYY-MM-DD")
  );
  const [salaryfrom, setsalaryfrom] = React.useState(props.state.salaryfrom);
  const [salaryto, setsalaryto] = React.useState(props.state.salaryto);

  //this code is for diplay or hide the occuption select
  const [occupation, setoccupation] = React.useState(props.state.disciplineid);
  const [speciality, setSpeciality] = React.useState(props.state.occupationid);

  //this code is for value of select form
  const [age, setAge] = React.useState(props.state.disciplineid);
  const [age2, setAge2] = React.useState(props.state.occupationid);
  const [startdateval, setstartdateval] = React.useState(props.state.startdate);
  const [enddateval, setenddateval] = React.useState(props.state.enddate);
  ...
  const [level1, setlevel1] = React.useState(props.state.level1);
  const [level2, setlevel2] = React.useState(props.state.level2);
  const [level3, setlevel3] = React.useState(props.state.level3);
  const [level4, setlevel4] = React.useState(props.state.level4);
  const [level5, setlevel5] = React.useState(props.state.level5);
  ...
  const [Status, setStatus] = React.useState(props.state.statusid);
  useEffect(() => {
    ...
    return (
      <>
        <div className="createrequistion_body">
          ...
          <div className="row">
            <h2>Update / Modify Requisition</h2>
          </div>
          <hr />
          {/* <div className="row">
                  ...
                  >
                    ...
                    >
                      ...
                      {state.occupation.map((occupa) => {
                        if (occupa.disciplineid === occupation) {
                          return (
                  ...
                  >
                    ...
                    >
                      ...
                      {state.specility.map((special) => {
                        if (speciality === special.occupationid) {
                          return (
            ...
            <div className="col-xl-6">
              ...
              >
                <TextField
                  required
                  value={requistionno}
                  onChange={(e) => setrequistionno(e.target.value)}
            ...
            <div className="col-xl-6">
              ...
              >
                <TextField
                  ...
                  type="number"
                  value={totalteam}
                  onChange={(e) => settotalteam(e.target.value)}
                  label="Total Team"
                  InputLabelProps={{
                    shrink: true,
                  }}
            ...
            <div className="col-xl-6">
              ...
              >
                <TextField
                  ...
                  type="number"
                  value={teamcost}
                  onChange={(e) => setteamcostno(e.target.value)}
                  label="Team Cost"
                  InputLabelProps={{
                    shrink: true,
                  }}
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    {status.map((special) => {
                      return (
                        <MenuItem value={special.id}>{special.status}</MenuItem>
                      );
                    })}
                  </Select>
                </FormControl>
